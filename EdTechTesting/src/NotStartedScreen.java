...
public class NotStartedScreen {
	...
	@Test (description = "Tests not started tab resume button click")
	public void TestNotStartedButtonClick() {
		
		// Navigate to not started tab
		tabClick = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/button[1]/span[1]"));
		tabClick.click();
		
		// Click start test button
		buttonClick = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[2]/div/div[1]/div"));
		buttonClick.click();
		
	}
	//*[@id="root"]/div[2]/div[2]/div/div[3]/table/tbody/tr[1]/td[2]
	//*[@id="root"]/div[2]/div[2]/div/div[2]/table/tbody/tr[1]/td[2]
